...
const getProfileHtml = function (user) {
    ...
    <picture>
                    <source type="image/webp"
                        srcset="./user.webp 1x, ./user@2x.webp 2x" />
                    <source type="image/png" srcset="./user.png 1x, ./user@2x.png 2x" />
                    <img class="user__image" src="./user.png" alt="User image" />
                </picture>
